...
default_train_conf = {
    ...
    'opt_regexp': '(head|decoder|adaptation|optimizer|uncertainty)',  # freeze retrieval encoder, fine-tune the rest
    ...
    'load_experiment': None, #'two_head_def',  # initialize the model from a previous experiment
