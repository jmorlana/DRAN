...
from .matrix_utils import matrix_from_se3, matrix_quaternion

Prediction = namedtuple('Prediction',
    'success num_matches num_inliers reference_inliers query_inliers quaternion matrix reference_filename reference_keypoints ref_id')
...
def solve_pnp(points_2D: np.ndarray,
    ...
    if success and len(inliers) >= minimum_inliers:
        ...
        assert success
        matrix = matrix_from_se3(tvec, rvec)
