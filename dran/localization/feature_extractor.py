...
from ..lib.datasets.view import resize, numpy_image_to_torch
...
class FeatureExtractor(torch.nn.Module):
    ...
    def __call__(self, image: np.array, scale_image: int = 1):
        ...
        hypercolumn = pred.get('hypercolumn')
        
        return features, scales, confidences, embedding, image_tensor, hypercolumn
